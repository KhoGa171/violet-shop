    ...
    <div class="card-body">
      <form method="post" action="{{route('brand.update',$brand->id)}}">
        ...
        <div class="form-group">
          <label for="inputTitle" class="col-form-label">Thương hiệu <span class="text-danger">*</span></label>
        <input id="inputTitle" type="text" name="title" placeholder="Nhập thương hiệu"  value="{{$brand->title}}" class="form-control">
        @error('title')
