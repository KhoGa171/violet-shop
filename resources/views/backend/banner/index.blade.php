...
<div class="card shadow mb-4">
  ...
  <div class="card-header py-3">
    ...
    <a href="{{route('banner.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Thêm ảnh bìa</a>
  </div>
  <div class="card-body">
    ...
    @else
    <h6 class="text-center">Không tìm thấy ảnh bìa !!! Vui lòng tạo ảnh bìa</h6>
    @endif
  </div>
</div>
</div>
