                                    ...
                                    <div class="product-img">
										...
										<div class="button-head">
											<div class="product-action">
												<a title="Wishlist" href="{{route('add-to-wishlist',$data->slug)}}" ><i class=" ti-heart "></i><span>Yêu thích</span></a>
											</div>
											<div class="product-action-2">
												<a data-toggle="modal" data-target="#{{$data->id}}" title="Xem nhanh" href="#">Thêm vào giỏ hàng</a>
											</div>
										</div>
                                    </div>
