...
<div class="container-fluid">
    ...
    <div class="d-sm-flex mb-4">
      <h5 class="font-weight-bold text-primary">Lịch sử mua hàng</h5>
    </div>
        ...
        <table class="table table-bordered" id="order-dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            @if(count($orders)>0)
              ...
              @endforeach
              @else
                <td colspan="8" class="text-center"><h4 class="my-4">Không tìm thấy đơn đặt hàng !!! Vui lòng đặt một số sản phẩm</h4></td>
              @endif
          </tbody>
        </table>
