...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     <h5 class="font-weight-bold text-primary">Thông tin cá nhân</h5>
                ...
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('user-profile-update',$profile->id)}}">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input id="inputAddress" type="text" name="address" placeholder="Enter address"  value="{{$profile->address}}" class="form-control">
                        @error('address')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
