...
class WishlistController extends Controller
{
    ...
    public function wishlist(Request $request){
        ...
        else $already_wishlist = Wishlist::where('session_id', $id_user)->where('cart_id',null)->where('product_id', $product->id)->first();
        ...
        if($already_wishlist) {
            ...
            else $wishlist->user_id = null;
            $wishlist->session_id = $id_user;
